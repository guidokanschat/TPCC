...
const char* output_2[] = { "0:4321", "1:4320", "0:4321", "2:4310", "1:4320", "2:4310", "0:4321",
                           "3:4210", "1:4320", "3:4210", "2:4310", "3:4210", "0:4321", "4:3210",
                           "1:4320", "4:3210", "2:4310", "4:3210", "3:4210", "4:3210"

};
const char* output_3[] = { "10:432", "20:431", "21:430", "10:432", "30:421", "31:420",
...
const char* output_4[] = { "210:43", "310:42", "320:41", "321:40", "210:43", "410:32", "420:31",
...
int main()
{
  // test<5,0>(); // Invalid, since you cannot eliminate a value from an empty combination. Tests
  // SFINAE.
  test<5, 1>();
  test<5, 2>();
  test<5, 3>();
